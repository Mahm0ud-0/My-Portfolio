...
const Apache = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
            ...
            <path
                fill="#BD202E"
                d="M74.234 58.596c-.467.081-.94.17-1.437.252 0 0-.007 0-.007.007l.74-.111c.23-.052.467-.096.704-.148Z"
            />
            <path
                fill="#BD202E"
                d="M74.234 58.596c-.467.081-.94.17-1.437.252 0 0-.007 0-.007.007l.74-.111c.23-.052.467-.096.704-.148Z"
            ...
            <path
                fill="#BD202E"
                d="M75.456 52.559s0 .007 0 0c-.007 0-.007 0-.007.007.074-.007.155-.022.23-.037.31-.044.614-.096.91-.17-.37.067-.74.133-1.133.2Z"
            />
            <path
                fill="#BD202E"
                d="M75.456 52.559s0 .007 0 0c-.007 0-.007 0-.007.007.074-.007.155-.022.23-.037.31-.044.614-.096.91-.17-.37.067-.74.133-1.133.2Z"
            ...
            <path
                fill="#BD202E"
                d="M73.516 58.729c-.245.044-.49.081-.741.111.252-.022.503-.067.74-.111Z"
            />
            <path
                fill="#BD202E"
                d="M73.516 58.729c-.245.044-.49.081-.741.111.252-.022.503-.067.74-.111Z"
            ...
            <path
                fill="#BD202E"
                d="M75.449 52.566c.074-.007.155-.022.23-.037-.075.008-.149.03-.23.037Z"
            />
            <path
                fill="#BD202E"
                d="M75.449 52.566c.074-.007.155-.022.23-.037-.075.008-.149.03-.23.037Z"
            ...
            <path
                fill="#BD202E"
                d="M75.449 52.566c.007 0 .007-.007 0 0 .007-.007.007 0 0 0Z"
            />
            <path
                fill="#BD202E"
                d="M75.449 52.566c.007 0 .007-.007 0 0 .007-.007.007 0 0 0Z"
            ...
            <defs>
                ...
                >
                    ...
                    <stop offset=".312" stopColor="#F69822" />
                    <stop offset=".838" stopColor="#E87726" />
                </linearGradient>
                <linearGradient
                    id="b"
                    x1="21.611"
                    ...
                    gradientUnits="userSpaceOnUse"
                >
                    <stop offset=".323" stopColor="#9C2063" />
                    <stop offset=".63" stopColor="#C82037" />
                    <stop offset=".751" stopColor="#CC2135" />
                ...
                >
                    ...
                    <stop offset=".095" stopColor="#662E8C" />
                    <stop offset=".788" stopColor="#9E2064" />
                    <stop offset=".949" stopColor="#CC2032" />
                </linearGradient>
                <linearGradient
                    id="d"
                    x1="23.576"
